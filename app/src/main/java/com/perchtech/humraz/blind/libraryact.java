...
import com.perchtech.humraz.blind.camera.CameraSource;
import com.perchtech.humraz.blind.camera.CameraSourcePreview;
 ...
 */
public final class libraryact extends AppCompatActivity{
    ...
    private void createCameraSource(boolean autoFocus, boolean useFlash) {
        ...
        textRecognizer.setProcessor(new librarydetector(mGraphicOverlay));
